...
def main():
    ...
    # -------------------------------------------------------------------------------- #
    # Parser for add_uniprot_information_to_alignments subcommand
    # -------------------------------------------------------------------------------- #
    parser_add_uniprot_information_to_alignments = subparsers.add_parser(
        "add_uniprot_information_to_alignments",
        help=(
            """
            This subcommand takes in uniprot information generated by query_uniprot and 
            adds it to a foldseek alignment.
            """
        ),
    )
    parser_add_uniprot_information_to_alignments.add_argument(
        "-a",
        "--alignment_file",
        type=str,
        required=True,
    ...
    parser_add_uniprot_information_to_alignments.add_argument(
        ...
        required=True,
        help="""
        Path to the uniprot information file generated by query_uniprot.
        """,
    )
    parser_add_uniprot_information_to_alignments.add_argument(
        "-o",
    ...
    parser_add_uniprot_information_to_alignments.set_defaults(
...
def call_add_uniprot_information_to_alignments_main(args):
    from scripts.add_uniprot_information_to_alignments import (
